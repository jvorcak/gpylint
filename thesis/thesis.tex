...
\end{lstlisting}
		...
		\subsection{Atribút \_\_name\_\_ }
...
\end{lstlisting}
		...
		\subsection{Funkcie hasattr() a getattr()}
...
\end{lstlisting}			
		...
		\subsection{Funkcie isinstance() a issubclass()}
